...
ARG BUILD_FROM=ghcr.io/chukysoria/baseimage-ubuntu:v0.3.67-noble@sha256:0b06acb7bd2c04c8c936c63c192ab12579e60cfcc7b8be9eb02cbc62ab2e0b23
FROM ${BUILD_FROM} 

# set version label
ARG BUILD_DATE
ARG BUILD_VERSION
ARG BUILD_EXT_RELEASE="v2.3.0.0_stable_2026-04-14"
